...
Public Class Stock_transfer_SF
        ...
        For i = 0 To dgv1.RowCount - 1
            With dgv1.Rows(i)
                ...
                If i = 0 Then
                    ...
                    ElseIf .Cells("org").Value = "I21" Or .Cells("org").Value = "I22" Or .Cells("org").Value = "I23" Or .Cells("org").Value = "I24" Or .Cells("org").Value = "I25" Or .Cells("org").Value = "I26" Or .Cells("org").Value = "I28" Or .Cells("org").Value = "I17" Then
                    ...
                    'Else
                    'sql &= ",'Regular-Skyfast'" ' Ended on 15jul2019
                    'End If

                    sql &= ",'Regular_Skyfast' " ' Sales Order type created on 15jul2019
    ...
    Private Sub Stock_transfer_SF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
